...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active menu" aria-current="page" href="../pages/index.php">Cadastre-se e entre na fila!</a>
                    </li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6"><br><br><br><br><br><br><br><br>
                <p class="primeiro-paragrafo">Cadastre-se agora</p>
                <p class="segundo-paragrafo">e fique na fila para usar o sistema</p>
                <p class="terceiro-paragrafo">Faça já seu cadastro com nome e e-mail. Seus dados serão submetidos e salvos para, assim que houver vaga, ser contatado sobre acesso ao sistema. </p>
                <!-- <form action="../pages/processar-cadastro.php" method="POST"> -->
                    <div class="col-sm-10">
            ...
            <div class="col-md-6"><br><br><br><br><br><br><br><br>
                <div class="image-container">
                    <img src="../img/imagem-de-fundo.png" class="rounded resp-img" height="600px" alt="Imagem de fundo.">
                </div>
            </div>
        </div>
    </div>
    ...
    if (isset($_GET['sucesso'])) {
        ...
        if ($sucesso == 1) {
            ...
            $erro = $_GET['erro'];
            if ($erro == 1) {
                $mensagem = "E-mail já foi usado para cadastro. Aguardar fila para receber contato do sistema.";
            } elseif ($erro == 2) {
                $mensagem = "Erro ao cadastrar, tente novamente.";
            } elseif ($erro == 3) {
                $mensagem = "A verificação falhou. Nenhum campo pode ser nulo e o nome só pode conter caracteres, tente novamente.";
            }
        }
    }
    ?>
