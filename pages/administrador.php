...
$sql = "SELECT id, nome, email, status FROM usuario WHERE categoria = 'Professor'";
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu active" href="../pages/administrador.php?id=<?php echo $id ?>" role="button">Painel</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link menu" href="../pages/feedback.php?id=<?php echo $id ?>" role="button">Feedbacks</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container mt-5">
        <p class="primeiro-paragrafo">Lista de Professores</p>
                    ...
                    <?php if ($result->num_rows > 0) : ?>
                        <?php while ($row = $result->fetch_assoc()) : ?>
                            <tr>
                                ...
                                <td style="color: <?php echo trim(strtolower($row['status'])) == 'ativo' ? 'green' : 'red'; ?>">
                                    <?php echo htmlspecialchars(ucfirst(trim($row['status']))); ?>
                                </td>
                                <td>
                                    <a href="editar_professor.php?id=<?php echo $id ?>&id_professor=<?php echo $row['id']; ?>" class="btn btn-primary">Editar</a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    <?php else : ?>
