...
<body>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="../pages/o-que-e.php">O que é?</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link menu" href="../pages/login.php" role="button">Entrar</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link menu active" href="../pages/contato.php" role="button">Contato</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6"><br><br><br><br><br><br><br><br>
                <p class="primeiro-paragrafo">Precisa de ajuda </p>
                <p class="segundo-paragrafo">ou quer dar lguma sugestão?</p>
                <p class="terceiro-paragrafo">Preencha o formulário abaixo e entre em contato!</p>
                <!-- <form action="../pages/processar-contato.php" method="POST"> -->
                    <div class="col-sm-10">
                        <input type="text" name="nome" placeholder="Nome" class="form-control" id="inputEmail3">
                    </div>
                    <br>
                    <div class="col-sm-10">
                        <input type="email" name="email" placeholder="E-mail" class="form-control" id="inputPassword3">
                    </div>
                    <br>
                    <div class="col-sm-10">
                        <input type="tel" name="telefone" placeholder="Telefone" class="form-control" id="inputTelefone">
                    </div>
                    <br>
                    <div class="col-sm-10">
                        <textarea name="mensagem" placeholder="Mensagem" class="form-control" id="mensagemTextarea" rows="5"></textarea>
                    </div>
                    <br>
            ...
            <div class="col-md-6"><br><br><br><br><br><br><br><br>
                <div class="image-container">
                    <img src="../img/contato.png" class="rounded resp-img" height="600px" alt="Imagem de fundo.">
                </div>
            </div>
        </div>
    </div>
    ...
    if (isset($_GET['sucesso'])) {
        ...
        if ($sucesso == 1) {
            ...
            $erro = $_GET['erro'];
            if ($erro == 1) {
                $mensagem = "A verificação falhou. Nenhum campo pode ser nulo, o nome pode conter apenas letras, e o telefone deve conter 11 dígitos (ddd+9).";
            } elseif ($erro == 2) {
                $mensagem = "Erro ao enviar, tente novamente.";
            }
        }
    }
    ?>
