...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu" href="../pages/professor.php?id=<?php echo $id ?>" role="button">Painel</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link menu" href="../pages/contato-professor.php?id=<?php echo $id ?>" role="button">Contato</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container">
        <p class="primeiro-paragrafo">Olá professor(a) </p>
