    ...
    <div class="container">
        <div class="row">
            <div class="col"><br><br><br><br>
                <p class="primeiro-paragrafo">O que é?</p>
                <p class="terceiro-paragrafo"> Ele usa a API aberta do Chat GPT, integrando na plataforma para uso de forma 100% gratuíta.</p>
            </div>
        </div>
    </div>
    <br><br><br>
