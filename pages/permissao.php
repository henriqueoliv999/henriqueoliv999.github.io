    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6"><br><br><br><br><br><br><br><br>
                <p class="primeiro-paragrafo">Opa,</p>
                <p class="segundo-paragrafo">Você não tem permissão para acessar essa página!</p>
            </div>
            <div class="col-md-6"><br><br><br><br><br><br><br><br>
                <div class="image-container">
                    <img src="../img/permissao.png" class="rounded resp-img" height="600px" alt="Imagem de fundo.">
                </div>
            </div>
        </div>
    </div>
