            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle active menu" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            Sobre
                        </a>
    ...
    <div class="container">
        <div class="row">
            <div class="col"><br><br><br><br>
                <p class="primeiro-paragrafo">Quem somos?</p>
                <p class="terceiro-paragrafo">O RedAI é um sistema desenvolvido para um projeto de graduação de faculdade. Ele é desenvolvido somente por mim, Henrique de Oliveira, aluno de Análise e desenvolvimento de sistemas na FATEC - Campinas.</p>
            </div>
        </div>
    </div>
    <br><br><br>
